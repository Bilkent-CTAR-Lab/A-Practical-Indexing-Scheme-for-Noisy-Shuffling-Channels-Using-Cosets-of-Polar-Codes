    ...
    for ik = 1:length(k_vec),
        ...
        for ipb = 1:length(p_bsc_vec),
            ...
            for sb = 1:sent_blocks,
                ...
                u = u_mat(sb,:); %round(rand(1,lbits) < 0.5);
                ...
                %polar_ber = sum(x ~= x_vec)/length(x_vec)
